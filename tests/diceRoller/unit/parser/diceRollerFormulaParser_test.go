...
func TestParseDiceRollerFormula_SimpleDice(t *testing.T) {
	components, err := dice.ParseDiceRollerFormula("1d20")
...
func TestParseDiceRollerFormula_DicePlusModifier(t *testing.T) {
	components, err := dice.ParseDiceRollerFormula("1d20+5")
	require.NoError(t, err)
...
func TestParseDiceRollerFormula_MultipleDiceTypes(t *testing.T) {
	components, err := dice.ParseDiceRollerFormula("2d6+1d4")
	require.NoError(t, err)
	require.Len(t, components, 2)
...
func TestParseDiceRollerFormula_MultipleDiceAndModifier(t *testing.T) {
	components, err := dice.ParseDiceRollerFormula("2d6+1d4+5")
	require.NoError(t, err)
